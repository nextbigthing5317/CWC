...
[...cards].forEach((card)=>{
    ...
    async function refresh()
    {
        ...
        else
        {
            ...
            document.getElementById('obj-7').src="comalis/"+result+"/7.jpeg";
            document.getElementById('obj-8').src="comalis/"+result+"/8.jpeg";
            document.getElementById('artist-1').src="comali/"+comali_list[result][0]+".jpg";
            document.getElementById('artist-2').src="comali/"+comali_list[result][1]+".jpg";
            document.getElementById('artist-3').src="comali/"+comali_list[result][2]+".jpg";
            document.getElementById('artist-4').src="comali/"+comali_list[result][3]+".jpg";
            document.getElementById('artist-5').src="comali/"+comali_list[result][4]+".jpg";
            document.getElementById('artist-6').src="comali/"+comali_list[result][5]+".jpg";
            document.getElementById('artist-7').src="comali/"+comali_list[result][6]+".jpg";
            document.getElementById('artist-8').src="comali/"+comali_list[result][7]+".jpg";
            var element = document.getElementById("Div2");
                    element.scrollIntoView({
                    behavior: "smooth",
                    block: "start",
        ...
        function displayingredients(id)
        {
            if (document.getElementById('dishes'))
            {
                ...
                document.getElementById('ques').style.display = 'none';
                    ...
                    document.getElementById('comali-turn-img').src = "comali/"+comali_list[result][artistid]+".jpg";
                }
            }
        }
